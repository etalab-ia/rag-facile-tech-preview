...
from ragtime.memory._paths import AGENT_DIR

if TYPE_CHECKING:
    from ragtime.memory.albert_search import AlbertMemoryIndex
...
def _get_albert_index() -> AlbertMemoryIndex | None:
    ...
    if _albert_index is None:
        from ragtime.memory.albert_search import AlbertMemoryIndex as _Index
...
def memory_search(query: str) -> str:
    ...
    from ragtime.memory.albert_search import fuse_search_results
    from ragtime.memory.search import keyword_search
