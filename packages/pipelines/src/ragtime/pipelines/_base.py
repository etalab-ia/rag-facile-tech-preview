...
no subclasses.  Use :func:`ragtime.pipelines.get_pipeline` to instantiate
a correctly configured pipeline from ``ragtime.toml``.
...
if TYPE_CHECKING:
    ...
    from ragtime.query import QueryExpander
...
class RAGPipeline:
    ...
    def _ensure_collection(self) -> int:
        ...
        if self._collection_id is None:
            ...
            name = f"ragtime-session-{time.time_ns()}"
    ...
    def retrieve_chunks(self, query: str, **kwargs: object) -> list[Any]:
        ...
        Returns:
            List of retrieved :class:`~ragtime.core.RetrievedChunk` dicts.
