"""Load ragtime JSONL datasets into Inspect AI format."""
...
def load_rag_dataset(path: str | Path) -> MemoryDataset:
    """Load a ragtime JSONL dataset into an Inspect AI Dataset.
    ...
    Args:
        path: Path to a ``.jsonl`` file produced by ``ragtime generate-dataset``.
