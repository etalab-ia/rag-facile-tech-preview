"""Inspect AI task definitions for ragtime evaluation."""
...
def rag_eval(
    ...
    """End-to-end evaluation of a ragtime RAG pipeline.
    ...
    fields.  Works with synthetic datasets (from ``ragtime generate-dataset``)
    and human gold-standard datasets alike — no chunk IDs required.

    Args:
        dataset_path: Path to a ragtime JSONL dataset.
