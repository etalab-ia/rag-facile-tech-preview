...
- Configurable formatting via `ragtime.core` config
...
Citation settings are inherited from `ragtime.core` config:
...
- **ragtime-lib**: Bundled together with all other pipeline modules
