...
- **Ingestion**: `AlbertProvider` removed from `rag_facile.ingestion` (relied on `parse()`). Use `provider = "local"` in `ragtime.toml`.
...
## [0.4.0](https://github.com/etalab-ia/ragtime/compare/albert-client-v0.3.7...albert-client-v0.4.0) (2026-02-13)
...
[0.3.7]: https://github.com/etalab-ia/ragtime/tree/v0.3.7/packages/albert-client
