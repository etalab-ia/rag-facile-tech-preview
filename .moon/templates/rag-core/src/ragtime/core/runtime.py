...
@lru_cache(maxsize=1)
def get_config(path: Path | str = "ragtime.toml") -> RAGConfig:
    ...
    Args:
        path: Path to configuration file (default: ragtime.toml)
...
def reload_config(path: Path | str = "ragtime.toml") -> RAGConfig:
...
def has_config_file(path: Path | str = "ragtime.toml") -> bool:
