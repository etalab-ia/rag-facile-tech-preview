...
def _find_config_file(filename: str = "ragtime.toml") -> Path | None:
...
def load_config(path: Path | str = "ragtime.toml") -> RAGConfig:
    ...
    Args:
        path: Path to TOML configuration file (default: ragtime.toml)
...
def load_config_or_default(path: Path | str = "ragtime.toml") -> RAGConfig:
    ...
    when no ragtime.toml is present.
...
def save_config(config: RAGConfig, path: Path | str = "ragtime.toml") -> None:
    ...
    Example:
        ...
        >>> save_config(config, "ragtime.toml")
    """
    path = Path(path)
...
def validate_config(path: Path | str = "ragtime.toml") -> RAGConfig:
    ...
    Example:
        ...
        >>> try:
        ...     config = validate_config("ragtime.toml")
...
def export_json_schema() -> str:
    """Export JSON Schema for ragtime.toml configuration.
